  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900">
                ...
                <form>
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input v-model="email" type="email" id="email" name="email" placeholder="email@email.com"
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <router-link to="/reset-password"
                        class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Esqueceu a
                        senha?</router-link>
                    </div>
                    <!-- Button -->
                    <div>
                      <button type="button" @click="toDashboard()" :disabled="!email || !password"
        ...
        <div class="hidden lg:grid relative items-center w-full h-full lg:w-1/2 dark:bg-white/5 bg-image div-logo">
          <img src="../../assets/img/smiletech-logo-2.png" width="300" alt="">
        </div>
      </div>
    </div>
  </FullScreenLayout>
