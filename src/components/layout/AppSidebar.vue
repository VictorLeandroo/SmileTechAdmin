<template>
  <aside :class="[
    ...
    <div :class="[
      ...
      <router-link to="/">
        <img v-if="isExpanded || isHovered || isMobileOpen" class="dark:hidden" src="/images/logo/smiletech-logo-2.png" alt="Logo"
          width="150" height="40" />
        <img v-if="isExpanded || isHovered || isMobileOpen" class="hidden dark:block" src="/images/logo/smiletech-logo-2.png"
          alt="Logo" width="150" height="40" />
        <img v-else src="/images/logo/smiletech-logo-2.png" alt="Logo" width="32" height="32" />
      </router-link>
    </div>
    ...
    items: [
      {
        icon: GridIcon,
        name: "Dashboard",
        subItems: [{ name: "Visão Geral", path: "/", pro: false }],
      },
      {
        icon: CalenderIcon,
        name: "Agenda",
