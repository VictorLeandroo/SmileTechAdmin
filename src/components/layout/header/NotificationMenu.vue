...
const notifications = ref([
  {
    ...
    action: 'agendou uma consulta para',
    project: 'Clareamento Dental',
    type: 'Agendamento',
    time: '2 min atrás',
    status: 'online',
  },
  {
    id: 2,
    userName: 'Dr. Marcos Oliveira',
    userImage: '/images/user/user-02.jpg',
    action: 'confirmou o atendimento de',
    project: 'Avaliação Ortodôntica',
    type: 'Profissional',
    time: '7 min atrás',
    status: 'offline',
  },
  {
    id: 3,
    userName: 'Larissa Couto',
    userImage: '/images/user/user-04.jpg',
    action: 'cancelou a consulta de',
    project: 'Limpeza Dental',
    type: 'Agendamento',
    time: '12 min atrás',
    status: 'online',
  },
  {
    id: 4,
    userName: 'Dr. Henrique Gomes',
    userImage: '/images/user/user-05.jpg',
    action: 'adicionou observações no prontuário de',
    project: 'Maria Eduarda',
    type: 'Prontuário',
    time: '20 min atrás',
    status: 'online',
  },
  {
    ...
    action: 'realizou pagamento referente a',
    project: 'Extração Simples',
    type: 'Financeiro',
    time: '28 min atrás',
    status: 'offline',
  },
  {
    id: 7,
    userName: 'Jéssica Alves',
    userImage: '/images/user/user-07.jpg',
    action: 'enviou novos exames para',
    project: 'Tratamento de canal',
    type: 'Documentos',
    time: '1 hora atrás',
    status: 'online',
  },
  {
    id: 8,
    userName: 'Dr. Rafaela Siqueira',
    userImage: '/images/user/user-09.jpg',
    action: 'solicitou revisão no plano de tratamento de',
    project: 'João Pedro',
    type: 'Profissional',
    time: '2 horas atrás',
    status: 'offline',
